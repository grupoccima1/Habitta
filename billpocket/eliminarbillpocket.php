            ...
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <th class="th__texto text-center">DEPOSITO_EN_BANCO</th>
                        <th class="th__texto text-center">TIPO_DE_PAGO</th>
                        <th class="th__texto text-center">FOLIO</th>
                        <th class="th__texto text-center">TIPO_DE_TARJETA</th>
                        <th class="th__texto text-center">TPVAFILIADA</th>
                        <th class="th__texto text-center">FECHADE_DEPOSITO</th>
                ...
                <div class="aler alert-danger" role="alert">
                    ...
                    <div class="d-flex justify-content-end">
                        <form class="me-2" action="./eliminar_billpocket.php" method="POST">
