              ...
              <div class="card-header bg-blue__500">
                <div class="row">
                  <div class="col text-white">
                   <img class="icon-home me-2" src="images/home.svg">  Home/Liberados
                  </div>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <table id="tabla" class="table table-striped data-table">
                    <thead class="bg__td bg-blue__400 text-white">
                      <tr class="text-center">
                          ...
                          <th class="d-none th__texto">Uso de cfdi</th>
                    ...
                    <?php
                          ...
                          ?>
                            ...
                            <td class="d-none"> <?php echo $item->IDCIF;?> </td>
                            ...
                            <td class="d-none"> <?php echo "$".number_format(floatval($item->FINANCIAMIENTO));?> </td>
                            ...
                            <td class="d-none"> <?php echo number_format($item->NO_1ER_MENS);?> </td>
                            <td class="d-none"> <?php echo "$".number_format(floatval($item->ER_MENSUALIDAD),2);?> </td>
                            <td class="d-none"> <?php echo number_format(floatval($item->NO_2DA_MENS));?> </td>
                            <td class="d-none"> <?php echo "$".number_format(floatval($item->DA_MENSUALIDAD),2); ?> </td>
                            <td class="d-none"> <?php echo number_format(floatval($item->NO_3ER_MENS));?></td>
                            <td class="d-none"> <?php echo "$".number_format(floatval($item->ER_MENSUALIDAD),2);?></td>
