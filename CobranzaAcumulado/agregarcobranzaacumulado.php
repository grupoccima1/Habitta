        ...
        <form action="./insertarcobranzaacumulado.php" method="post">
          <div class="row">
            ...
            <div class="col-4 mb-2">  
              ...
              <input type="text" class="form-control" id="MESES_1" name="MESES_1">
            </div>
            <div class="col-4 mb-2">  
              <label for="MESES_2">MESES:2</label>
              <input type="text" class="form-control" id="MESES_2" name="MESES_2">
            </div>
            <div class="col-4 mb-2">  
              <label for="MESES_3">MESES_3</label>
              <input type="text" class="form-control" id="MESES_3" name="MESES_3">
            </div>
            <div class="col-4 mb-2">  
            ...
            <div class="col-4 mb-2">  
              ...
              <input type="text" class="form-control" id="MEN_1" name="MEN_1">
            </div>
            <div class="col-4 mb-2">  
              <label for="MEN_2">MEN_2</label>
              <input type="text" class="form-control" id="MEN_2" name="MEN_2">
            </div>
            <div class="col-4 mb-2">  
              <label for="MEN_3">MEN_3</label>
              <input type="text" class="form-control" id="MEN_3" name="MEN_3">
            </div>
            <div class="col-4 mb-2">  
            ...
            <div class="col-4 mb-2">  
              <label for="enero_2024">enero_2021</label>
