...
//  echo "Producto: " . $documento->nombre . ", Precio: $" . $precio_formateado . PHP_EOL;
// } else {
// // Si no es numérico, mostrar tal cual sin formato
// echo "Producto: " . $documento->nombre . ", Precio: " . $precio . PHP_EOL;
// }
// }
