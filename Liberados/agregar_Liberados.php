...
<div class="container">
    <div class="row">
        <div class="card mt-4">
            <div class="card-body">
                <h2 class="mb-2 fs-4 text-center">Nuevo Registro</h2>
                <form action="./insertar_Liberados.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="idcif" id="idcif" class="form-control">
                        </div>
                        <div class="col-4 mb-2">
                   ...
                   <div class="d-flex justify-content-end">
                        ...
                        <a href="../liberados.php" class="btn btn-secondary mt-3 px-5">
                            Cancelar
                        </a>
                   </div>
                </form>
