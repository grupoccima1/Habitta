<<<<<<< HEAD:Liberados/modificar_Liberados.php
<?php 
    include "../header.php";
    ...
    <div class="row">
        <div class="card mt-4">
            <div class="card-body">
                ...
                <form action="../Liberados/actualizar_Liberados.php" method="POST">
...
>>>>>>> 5ccd7b2a901cb555888b0325e6467b8998284a00:modulos/actualizar_Liberados.php
