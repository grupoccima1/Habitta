    ...
    <div class="row">
        <div class="card mt-4">
            ...
            <div class="card-body">
                    ...
                    <form action="./actualizar_HSBCLOMAS.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-4 mb-2">
                                ...
                                <input type="text" name="UNIDADDENEGOCIO" id="UNIDADDENEGOCIO" class="form-control" value="<?php echo $datos->UNIDADDENEGOCIO ?>">
                            </div>
                            <div class="col-4 mb-2">
