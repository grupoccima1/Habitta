                  ...
                  <table id="tabla" class="table table-striped data-table">
                    ...
                    <?php
                          ...
                          ?>
                            ...
                            <td> <?php echo "$".number_format(floatval($item->lTOTA_DE_LAVENTA),2);?></td>
                            <td> <?php echo "$".number_format(floatval($item->ENGANCHE),2);?> </td>
                            <td> <?php echo number_format(floatval($item->PCOMISION));?> </td>
                            ...
                            <td> <?php echo "$".number_format(floatval($item->APAGAR_EXTERNOS),2);?> </td>
