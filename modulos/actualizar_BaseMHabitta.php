<?php 
    ...
    $crud = new Crud();
    $id = $_POST['id'];
    $datos = $crud->obtenerDocumentoMadreHabitta($id);
    $idMongo = $datos->_id;
?>
    ...
    <div class="row">
        <div class="card mt-4">
            <div class="card-header">
                <a href="../basemadrehabitta.php" class="btn btn-outline-info">
                    Regresar
                </a>
<<<<<<< HEAD
                ...
                <form action="../procesos/actualizar_BaseMHabitta.php" method="POST">
                    ...
                    <input type="text" name="primer_mens" id="primer_mens" class="form-control"  value="<?php echo $datos->PRIMERA_MENSUALIDAD ?>">
                    ...
                    <input type="text" name="segunda_mens" id="segunda_mens" class="form-control"  value="<?php echo $datos->SEGUNDA_MENSUALIDAD ?>">
                    ...
                    <input type="text" name="tercer_mens" id="tercer_mens" class="form-control"  value="<?php echo $datos->TERCER_MENSUALIDAD ?>">
                    ...
                    <input type="text" name="apartado" id="apartado" class="form-control"  value="<?php echo $datos->APARTADO_TELEGRAM ?>">
                    <label for="primera_mens">Primer Mensualidad</label>
                    <input type="text" name="primera_mens" id="primera_mens" class="form-control"  value="<?php echo $datos->PRIMER_MENSUALIDAD ?>">
=======
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="dom_fiscal" id="dom_fiscal" class="form-control"
                                value="<?php echo $datos->DOMICILIO_FISCAL ?>">
                        </div>
                        <div class="col-4 mb-2">
                            <label for="telefono">Telefono</label>
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="total_operacion" id="total_operacion" class="form-control"
                                value="<?php echo $datos->TOTAL_OPERACION ?>">
                        </div>
                        <div class="col-4 mb-2">
                            <label for="enganche">Enganche</label>
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="apartado" id="apartado" class="form-control"
                                value="<?php echo $datos->APARTADO_TELEGRAM ?>">
                        </div>
                        <div class="col-4 mb-2">
                            <label for="primera_mens">Primer Mensualidad</label>
                            <input type="text" name="primera_mens" id="primera_mens" class="form-control"
                                value="<?php echo $datos->PRIMER_MENSUALIDAD ?>">
                        </div>
                    </div>
