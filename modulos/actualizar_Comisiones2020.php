<?php 
    ...
    $crud = new Crud();
    $id = $_POST['id'];
    $datos = $crud -> obtenerDocumentoComisiones2020($id);
    $idMongo = $datos -> _id;
?>
    ...
    <div class="row">
        <div class="card mt-4">
            <div class="card-body">
                ...
                <form action="../procesos/actualizar_Comisiones2020.php" method="POST">
                    ...
                    <input type="text" name="fecha_pagada" id="fecha_pagada" class="form-control" value="<?php echo $datos->SEMANA_PAGADA ?>">
                    ...
                    <input type="text" name="regimen" id="regimen" class="form-control" value="<?php echo $datos->XTIPO_DE_REGIMEN ?>">
                    ...
                    <label for="total_venta">Total de la Venta</label>
                    <input type="text" name="total_venta" id="total_venta" class="form-control" value="<?php echo $datos->TOTAL_DELA_VENTA ?>">
                    <label for="xtipo">X Tipo de Regimen</label>
                    <input type="text" name="xtipo" id="xtipo" class="form-control" value="<?php echo $datos->X_TIPO_DE_REGIMEN ?>">
