<?php
    ...
    $crud = new Crud();
    $id = $_POST['id'];
    $datos = $crud -> obtenerDocumentoComisiones2022($id);
    $idMongo = $datos -> _id;
?>
    ...
    <div class="row">
        <div class="card mt-4">
            <div class="card-body">
                ...
                <a href="../comisiones2022.php" class="btn btn-outline-info">
                    Regresar
                </a>

                <h2>Actualizar Registro</h2>
                <form action="../procesos/actualizar_Comisiones2022.php" method="POST">
                    ...
                    <input type="text" name="fecha_ingreso" id="fecha_ingreso" class="form-control" value="<?php echo $datos->FECHA_DE_INGRESO ?>">
                    ...
                    <input type="text" name="total_venta" id="total_venta" class="form-control" value="<?php echo $datos->TOTAL_DE_LA_VENTA ?>">
                    ...
                    <input type="text" name="pagar_externos" id="pagar_externos" class="form-control" value="<?php echo $datos->A_PAGAR_EXTERNOS ?>">
                    ...
                    <input type="text" name="retenciones_iva" id="retenciones_iva" class="form-control" value="<?php echo $datos->RETENCIONES_DE_IVA ?>">
                    ...
                    <input type="text" name="sem_pagada" id="sem_pagada" class="form-control" value="<?php echo $datos->SEMANA_PAGADA ?>">
                    ...
                    <input type="text" name="regimen" id="regimen" class="form-control" value="<?php echo $datos->X_TIPO_DE_REGIMEN ?>">
                    ...
                    <input type="text" name="mot_descuento" id="mot_descuento" class="form-control" value="<?php echo $datos->MOTIVO_DE_DESCUENTO ?>">
                    ...
                    <input type="text" name="pagar_externos" id="pagar_externos" class="form-control" value="<?php echo $datos->A_PAGA_EXTERNOS ?>">
                    <label for="loteanterior">Lote Anterior</label>
                    <input type="text" name="loteanterior" id="loteanterior" class="form-control" value="<?php echo $datos->LOTEANTERIOR ?>">
