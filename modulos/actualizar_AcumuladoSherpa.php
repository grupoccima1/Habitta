<?php 
    ...
    $crud = new Crud();
    $id = $_POST['id'];
    $datos = $crud -> obtenerDocumentoAcumuladosSherpa($id);
    $idMongo = $datos -> _id;
?>
<div class="container">
    <div class="row">
        <div class="card mt-4">
            <div class="card-body">
                ...
                <form action="../procesos/actualizar_AcumuladoSherpa.php" method="POST">
                    ...
                    <input type="text" name="tipo_regimen" id="tipo_regimen" class="form-control" value="<?php echo $datos->X_TIPO_DE_REGIMEN ?>">
                    ...
                    <input type="text" name="motivo_desc" id="motivo_desc" class="form-control" value="<?php echo $datos->MOTIVO_DE_DESCUENTO ?>">
