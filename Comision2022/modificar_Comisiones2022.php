<?php
    ...
    $id = $_POST['id'];
    $datos = $crud -> obtenerDocumentoComision2022($id);
    $idMongo = $datos -> _id;
?>
    ...
    <div class="row">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <form action="../Comision2022/actualizar_Comisiones2022.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="pagar_externos" id="pagar_externos" class="form-control"
                                value="<?php echo $datos->A_PAGA_EXTERNOS ?>">
                        </div>
                        <div class="col-4 mb-2">
                            <label for="loteanterior">Lote Anterior</label>
                            <input type="text" name="loteanterior" id="loteanterior" class="form-control"
                                value="<?php echo $datos->LOTEANTERIOR ?>">
                        </div>
                    </div>
