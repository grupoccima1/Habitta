<?php 
    ...
    $datos = $crudcomision2022 -> obtenerDocumentoComision2022($id);
?>
                ...
                <div class="col">
                    ...
                    <div class="aler alert-danger" role="alert">
                        ...
                        <div class="d-flex justify-content-end">
                            <form class="me-2" action="./eliminar_comision2022.php" method="POST">
                                <input type="text" name="id" value="<?php echo $datos->_id;?>" hidden>
                                <button class="btn btn-danger">
                                    Eliminar
                                </button>
                            </form>
                            <a href="../comisiones2022.php" class="btn btn-secondary">Cancelar</a>
                        </div>
                    </div>
                </div>
            </div>
