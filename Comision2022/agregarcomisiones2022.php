...
<div class="container">
  <div class= "card mt-4">
      <div class= "card-body">
          ...
          <form action="./insertarcomision2022.php" method="post">
            <div class="row">
              ...
              <div class="col-4 mb-2">
                <label for="A_PAGA_EXTERNOS">A PAGA EXTERNOS</label>
                <input type="text" class="form-control" id="A_PAGA_EXTERNOS" name="A_PAGA_EXTERNOS">
              </div>
              <div class="col-4 mb-2">
                <label for="LOTE ANTERIOR">LOTE ANTERIOR</label>
                <input type="text" class="form-control" id="LOTE ANTERIOR" name="LOTE ANTERIOR">
              </div>
            </div>
