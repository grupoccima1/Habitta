<?php 
    ...
    $datos = $crudcomisiones2020 -> obtenerDocumentoComision2020($id);
?>
                ...
                <div class="col">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <th class="th__texto text-center">TOTAL_DELA_VENTA</th>
                            <th class="th__texto text-center">X_TIPO_DE_REGIMEN</th>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center"> <?php echo $datos->TOTAL_DELA_VENTA;?> </td>
                                <td class="text-center"> <?php echo $datos->X_TIPO_DE_REGIMEN;?> </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <div class="aler alert-danger" role="alert">
                        ...
                        <div class="d-flex justify-content-end">
                            <form class="me-2" action="./eliminar_comisiones2020.php" method="POST">
                                <input type="text" name="id" value="<?php echo $datos->_id;?>" hidden>
                                <button class="btn btn-danger">
                                    Eliminar
                                </button>
                            </form>
                            <a href="../comisiones2020.php" class="btn btn-secondary">Cancelar</a>
                        </div>
                    </div>
                </div>
            </div>
