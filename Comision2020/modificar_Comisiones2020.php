<?php 
    ...
    $id = $_POST['id'];
    $datos = $crud -> obtenerDocumentoComision2020($id);
    $idMongo = $datos -> _id;
?>
    ...
    <div class="row">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <form action="../Comision2020/actualizar_Comisiones2020.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="regimen" id="regimen" class="form-control"
                                value="<?php echo $datos->XTIPO_DE_REGIMEN ?>">
                        </div>
                        <div class="col-4 mb-2">
                        ...
                        <div class="col-4 mb-2">
                            <label for="total_venta">Total de la Venta</label>
                            <input type="text" name="total_venta" id="total_venta" class="form-control"
                                value="<?php echo $datos->TOTAL_DELA_VENTA ?>">
                        </div>
                        <div class="col-4 mb-2">
