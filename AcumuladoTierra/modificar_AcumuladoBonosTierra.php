            ...
            <div class="card-body">
                <div class="col">
                    ...
                    <form action="../AcumuladoTierra/actualizar_AcumuladoBonosTierra.php" method="POST">
                        ...
                        <div class="row">
                        <!-- Actualizado para acceder a los valores del array $datos -->
                        ...
                        <div class="col-12 col-md-4">
                            ...
                            <input type="text" name="total_de_la_venta" id="total_de_la_venta" class="form-control"
                        ...
                        <div class="col-12 col-md-4">
                            <label for="p_comision">% Comisión</label>
                            <input type="text" name="p_comision" id="p_comision" class="form-control"
                                value="<?php echo $datos['p_comision'] ?>">
                        </div>
                        <div class="col-12 col-md-4">
                            ...
                            <div class="col-12 col-md-4">
                                ...
                                <input type="text" name="subtotal" id="subtotal" class="form-control"
                                    value="<?php echo $datos['sub_total'] ?>">
                            </div>
                            <div class="col-12 col-md-4">
                        ...
                        <div class="col-12 col-md-4">
                            <label for="tipo_regimen">X Tipo de Régimen</label>
