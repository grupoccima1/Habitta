    ...
    <div class="row">
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <form action="../AcumuladoDeComisiones/actualizar_AcumuladoComisiones.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="total_venta" id="total_venta" class="form-control" value="<?php echo $datos->lTOTA_DE_LAVENTA ?>">
                        </div>
                        <div class="col-4 mb-2">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="pagar_externos" id="pagar_externos" class="form-control" value="<?php echo $datos->APAGAR_EXTERNOS ?>">
                        </div>
                        <div class="col-4 mb-2">
