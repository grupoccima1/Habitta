...
<div class="container">
  <div class="card mt-4">
    <div class="card-body">
      ...
      <form action="./insertaracumuladodecomisiones.php" method="post">
        <div class="row">
          ...
          <div class="col-4 mb-2">
            <label for="NOMBRE_CORRECTO">NOMBRE_CORRECTO</label>
            <input type="text" class="form-control" id="NOMBRE_CORRECTO" name="NOMBRE_CORRECTO">
          </div>
          <div class="col-4 mb-2">
            <label for="lTOTA_DE_LAVENTA">TOTAL DE LA VENTA</label>
            <input type="text" class="form-control" id="lTOTA_DE_LAVENTA" name="lTOTA_DE_LAVENTA">
          </div>
          <div class="col-4 mb-2">
