                    ...
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="nombre_cliente" id="nombre_cliente" class="form-control"
                                value="<?php echo $datos->NOMBRE_DEL_CLIENTE ?>">
                        </div>
                        <div class="col-4 mb-2">
                            <label for="fecha_apartado">Fecha Apartado</label>
                            <input type="text" name="fecha_apartado" id="fecha_apartado" class="form-control"
                                value="<?php echo $datos->FECHA_DE_APARTADO ?>">
                        </div>
                        <div class="col-4 mb-2">
                            ...
                            <input type="text" name="fecha_entrega" id="fecha_entrega" class="form-control"
                                value="<?php echo $datos->FECHA_ENTREGA_DE_CONTRATO ?>">
                        </div>
                        <div class="col-4 mb-2">
                            <label for="importe_comision">Importe a Comisionar</label>
                            <input type="text" name="importe_comision" id="importe_comision" class="form-control"
                                value="<?php echo $datos->IMPORTE_A_COMISIONAR ?>">
                        </div>
                        <div class="col-4 mb-2">
