    ...
    <div class="row">
        <div class="card mt-4">
            <div class="card-header">
                <a href="../tabulador.php">
                    Regresar
                </a>
            </div>
            <div class="card-body">
                    <h2 class="mb-3 fs-4 text-center"> Actualizar Registro</h2>
                    <form action="./actualizar_Tabulador.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-4 mb-2">
                                ...
                                <input type="text" name="INTERESFINANCIAMIENTO" id="id" class="form-control" value="<?php echo $datos->INTERESFINANCIAMIENTO ?>">
                            </div>
                            <div class="col-4 mb-2">
                            ...
                            <div class="col-4 mb-2">
                                <label for="INT_PAGADO">INT_PAGADO</label>
                            ...
                            <div class="col-4 mb-2">
                                <label for="SUMA_DEUDA">SUMA_DEUDA</label>
                                <input type="text" name="SUMA_DEUDA" id="SUMA_DEUDA" class="form-control" value="<?php echo $datos->SUMA_DEUDA ?>">
                            </div>
                        </div>
