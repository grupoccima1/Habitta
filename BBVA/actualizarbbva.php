    ...
    <div class="row">
        <div class="card mt-4">
            ...
            <div class="card-body">
                    ...
                    <form action="./actualizar_BBVA.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-4 mb-2">
                                ...
                                <input type="text" name="SALDO" id="id" class="form-control" value="<?php echo $datos->SALDO ?>">
                            </div>
                            <div class="col-4 mb-2">
                            ...
                            <div class="col-4 mb-2">
                                <label for="MODELODENEGOCIO">MODELODENEGOCIO</label>
                                <input type="text" name="MODELODENEGOCIO" id="MODELODENEGOCIO" class="form-control" value="<?php echo $datos->MODELODENEGOCIO ?>">
                            </div>
                            <div class="col-4 mb-2">
                            ...
                            <div class="col-4 mb-2">
                                ...
                                <input type="text" name="FECHACORRECTA" id="FECHACORRECTA" class="form-control" value="<?php echo $datos->FECHACORRECTA ?>">
                            </div>
                            <div class="col-4 mb-2">
                                <label for="LLAVEEDOSDECUENTA">LLAVEEDOSDECUENTA</label>
                                <input type="text" name="LLAVEEDOSDECUENTA" id="LLAVEEDOSDECUENTA" class="form-control" value="<?php echo $datos->LLAVEEDOSDECUENTA ?>">
                            </div>
                            <div class="col-4 mb-2">
                            ...
                            <div class="col-4 mb-2">
                                ...
                                <input type="text" name="METODODEPAGO" id="METODODEPAGO" class="form-control" value="<?php echo $datos->METODODEPAGO ?>">
                            </div>
                        </div>
