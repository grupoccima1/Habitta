...
<div class="container">
  <div class= "card mt-4">
    <div class= "card-body">
        ...
        <form action="./insertarbbva.php" method="post">
          <div class="row">
            ...
            <div class="col-4 mb-2">
              ...
              <input type="text" class="form-control" id="MODELODENEGOCIO" name="MODELODENEGOCIO">
            </div>
            <div class="col-4 mb-2">
          ...
          <div class="d-flex justify-content-end">
            ...
            <a href="../bbva.php" class="btn btn-secondary mt-3 px-5">
              Cancelar
            </a>
          </div>
        </form>
...
<script>
    ...
    const url = "./obtenerSaldoBBVA.php";
