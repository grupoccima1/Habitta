                ...
                <table id="tabla" class="table table-striped data-table" style="width: 100%">
                  ...
                  <?php
                        ...
                        ?>
                          ...
                          <td class="text-center"> <?php echo $item->PORTTO_BLANCO_CIM;?> </td>
                          <td class="text-center"> <?php echo $item->LOMAS_DE_PORTTO_BLANCO;?> </td>
                          <td class="text-center"> <?php echo $item->PORTTO_BLANCO_BERNAL;?> </td>
                          <td class="text-center"> <?php echo $item->VEREDAS_DE_LIRA;?> </td>
                          <td class="text-center"> <?php echo $item->PORTTO_BLANCO_SLP;?> </td>
                          <td class="text-center"> <?php echo $item->GENERAL;?> </td>
