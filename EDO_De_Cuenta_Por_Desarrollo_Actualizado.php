<?php
  ...
  require_once "./CuentaDesarrolloActualizado/crudcuentapordesarrolloactualizado.php";
  $crud = new crudcuentapordesarrolloactualizado();
  $datos = $crud->mostrarDatosCuentaDesarrolloActualizado();
?>
<!DOCTYPE html>
<html lang="es">
  ...
  <div class="wrapper">
    ...
    <div id="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <h2>Estado de Cuenta por Desarrollo</h2>
          </div>
        </div>
            ...
            <div class="card-header bg-blue__500">
              <div class="row">
                <div class="col text-white">
                  <img class="icon-home me-2" src="images/home.svg"> Home/Estado de Cuenta por Desarrollo
                </div>
              </div>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <a href="./CuentaDesarrolloActualizado/agregarcuentapordesarrolloactualizado.php"
                ...
                <table id="tabla" class="table table-striped data-table">
                  <thead class="bg__td bg-blue__400 text-white">
                    <tr class="text-center">
                      ...
                      <th class="d-none th__texto">PORTTO_BLANCO_SLP</th>
                      <th class="d-none th__texto">GENERAL</th>
                  ...
                  <tbody>
                    ...
                    <tr class="text-center">
                      ...
                      <td class="d-none"> <?php echo number_format(floatval($item->PORTTO_BLANCO_SLP),2);?> </td>
                      <td class="d-none"> <?php echo number_format(floatval($item->GENERAL),2);?> </td>
                      <td>
                      ...
                      <td>
                        <form action="./CuentaDesarrolloActualizado/eliminarcuentadesarrolloactualizado.php"
                          method="POST">
                          <input type="text" name="id" id="id" hidden value="<?php echo $item->_id ?>">
