              ...
              <div class="card-header bg-blue__500">
                <div class="row">
                  <div class="col text-white">
                   <img class="icon-home me-2" src="images/home.svg">  Home/Comisiones 2020
                  </div>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <table id="tabla" class="table table-striped data-table">
                    <thead class="bg__td bg-blue__400 text-white">
                      <tr class="text-center">
                          ...
                          <th class="d-none th__texto">TOTAL_DELA_VENTA</th>
                          <th class="d-none th__texto">X_TIPO_DE_REGIMEN</th>
                    ...
                    <?php
                          ...
                          ?>
                            ...
                            <td class="d-none"> <?php echo "$".number_format(floatval($item->TOTAL_DELA_VENTA),2);?> </td>
                            <td class="d-none"> <?php echo $item->X_TIPO_DE_REGIMEN;?> </td>
                            <td>
