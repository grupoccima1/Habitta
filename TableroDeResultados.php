                ...
                <table id="tabla" class="table table-striped data-table" style="width: 100%">
                  ...
                  <?php
                        ...
                        ?>
                          ...
                          <td class="text-center"> <?php echo $item->U_TOTALES;?> </td>
                          <td class="text-center"> <?php echo $item->U_APARTADAS;?> </td>
                          <td class="text-center"> <?php echo $item->U_PORVENDER;?> </td>
                          <td class="text-center"> <?php echo $item->U_VENDIDAS;?> </td>
                          <td class="text-center"> <?php echo $item->U_POR_CERRAR; ?> </td>
                          <td class="text-center"> <?php echo $item->U_POR_RECUPERAR;?> </td>
                          <td class="text-center"> <?php echo $item->RECUPERADOS;?> </td>
                          <td class="text-center"> <?php echo $item->DESARROLLO;?></td>
                          <td class="text-center"> <?php echo $item->U_POR_VENDER;?> </td>
                          <td class="text-center"> <?php echo $item->ESTATUS;?> </td>
                          <td class="text-center"> <?php echo $item->TOTAL_VENCIDOS;?> </td>
